...
This fork disables the app's online update checks and automatic installation.
When updating, rebuild and install a new version from your own fork manually;
the app will not treat the official release as an update target.
